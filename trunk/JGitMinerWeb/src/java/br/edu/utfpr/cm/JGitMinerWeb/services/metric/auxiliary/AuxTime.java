...
public class AuxTime {
    ...
    public AuxTime(AuxPairOfFiles auxCoChanged, GenericDao dao) {
        ...
        this.dateFile1 = new DateTime(repositoryCommitFile1.getCommit().getCommitter().getDateCommitUser(), DateTimeZone.UTC);
        this.dateFile2 = new DateTime(repositoryCommitFile2.getCommit().getCommitter().getDateCommitUser(), DateTimeZone.UTC);
    }
