...
import br.edu.utfpr.cm.JGitMinerWeb.services.matrix.auxiliary.AuxNumberInteressados;
 ...
 * @author geazzy
 */
public class NumeroDeInteressadosNaIssueServices extends AbstractMatrixServices {
    ...
    public NumeroDeInteressadosNaIssueServices(GenericDao dao, EntityRepository repository, List<EntityMatrix> matricesToSave, Map params, OutLog out) {
