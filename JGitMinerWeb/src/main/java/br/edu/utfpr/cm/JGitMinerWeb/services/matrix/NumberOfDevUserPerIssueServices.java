...
import br.edu.utfpr.cm.JGitMinerWeb.services.matrix.auxiliary.AuxNumberOfDevUser;
import br.edu.utfpr.cm.JGitMinerWeb.services.matrix.auxiliary.AuxUserComments;
 ...
 * @author geazzy
 */
public class NumberOfDevUserPerIssueServices extends AbstractMatrixServices {

    private List<AuxNumberOfDevUser> issueList;

    public NumberOfDevUserPerIssueServices(GenericDao dao, OutLog out) {
        super(dao, out);
        issueList = new ArrayList<>();
    }

    public NumberOfDevUserPerIssueServices(GenericDao dao, EntityRepository repository, List<EntityMatrix> matricesToSave, Map params, OutLog out) {
    ...
    public String getHeadCSV() {
        return "IssueNumber;dev;users;total;url";
    }
