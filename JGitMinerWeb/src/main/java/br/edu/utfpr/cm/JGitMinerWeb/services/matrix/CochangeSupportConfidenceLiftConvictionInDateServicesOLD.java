 ...
 * @author Douglas
 */
public class CochangeSupportConfidenceLiftConvictionInDateServicesOLD extends AbstractMatrixServices {

    public CochangeSupportConfidenceLiftConvictionInDateServicesOLD(GenericDao dao, OutLog out) {
        super(dao, out);
    }

    public CochangeSupportConfidenceLiftConvictionInDateServicesOLD(GenericDao dao, EntityRepository repo, List<EntityMatrix> matrices, Map params, OutLog out) {
